                    ...
                    if(item.type=='clothes'||item.type=='ears'||item.type=='left hand'||item.type=='hat'||item.type=='right hand'||item.type=='neck'){
                        if(checkItemInInventory(item.id)==false){
                                if(item.rarity=='common'){
                                    return(
                                        <div className={'w-[48%] sm:w-[23%] sm:mt-[0vw] sm:mb-[4vw] mb-[2vh] mt-[2vh]'}>
                                            <div className={'w-full relative h-[23vh] sm:h-[23.2vw] rounded-[2vw]'}  key={item.id}>
                                                ...
                                                <div className={'w-[2vh] sm:w-[2vw] sm:h-[2vw] h-[2vh] absolute top-[1vh] left-[1vh]'}>
                                                    <Image src={'/images/equipment_module/'+item.type+'.svg'} layout={'fill'}></Image>
                                                </div>
                                                <p className={'text-white font-josefin text-[1.8vh] sm:text-[1.8vw] text-right absolute top-[1vh] right-[1vh]'}>ID: {item.id}</p>
                                                <p className={'w-full text-white font-soyuz text-[1.8vh] sm:text-[1.8vw] text-center'}>{item.name}</p>
                                                <div className={'relative w-[70%] mx-auto border-[#000]'}>
                                                    {item.dex!=0?
                                                        <div className={'w-full relative flex justify-between items-center'}>
                                                            <div className={'w-[2vh] sm:w-[2vw] sm:h-[2vw] h-[2vh] relative inline-block'}>
                                            ...
                                            <div className={'w-[80%] mx-auto mt-[1vh] sm:mt-[2vw] flex justify-between'}>
                                                <div className={'w-[50%] inline-block'}>
                                                    <p className={'text-white inline-block align-top text-[2.5vh] sm:text-[2vw] font-bold font-josefin'}>{item.rentPrice}</p>
                                                    <div className={'w-[3.5vh] h-[3.5vh] sm:w-[3vw] sm:h-[3vw] align-top ml-[10%] inline-block relative'}>
                                                        <Image src={'/images/wallet_carrot.png'} layout={'fill'}></Image>
                                                    </div>
                                                </div>
                                                <button className={'w-[50%] sm:h-[3vw] bg-[#E9E9E9] h-[3.5vh] rounded-full text-white inline-block align-top text-[2.5vh] sm:text-[2vw] text-[#000] font-bold font-soyuz'} onClick={()=>{RentItem(item)}}>
                                                    buy
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    return(
                                        <div className={'w-[48%] sm:w-[23%] sm:mt-[0vw] sm:mb-[4vw] mt-[2vh] mb-[2vh]'}>
                                            <div className={'w-full relative h-[23vh] sm:h-[23.2vw] rounded-[2vw]'}  key={item.id}>
                                                <div className={'w-full absolute top-0 rounded-[2vw] h-full'}>
                                            ...
                                            <div className={'w-[80%] mx-auto mt-[1vh] sm:mt-[2vw] flex justify-between'}>
                                                ...
                                                <button className={'w-[50%] sm:h-[3vw] bg-[#DCF646] h-[3.5vh] rounded-full text-white inline-block align-top text-[2.5vh] sm:text-[2vw] text-[#000] font-bold font-soyuz'} onClick={()=>{RentItem(item)}}>
                                                    buy
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    return(
                                        <div className={'w-[48%] sm:w-[23%] sm:mt-[0vw] sm:mb-[4vw] mt-[2vh] mb-[2vh]'}>
                                                ...
                                                <div className={'align-top relative w-[40%] inline-block ml-[2%] mr-[8%]'}>
                                                    ...
                                                    {item.requirements?.dex!=0&&item.requirements?.dex!=undefined?
                                                        <div className={'w-full relative flex justify-center items-center'}>
                                                            <div className={'w-[2vh] sm:w-[2vw] sm:h-[2vw] mx-[1vh] h-[2vh] relative inline-block'}>
                                                                <Image src={'/images/card_generation/epic/dex.svg'} layout={'fill'}></Image>
                                                            </div>
                                                    ...
                                                    {item.requirements?.str!=0&&item.requirements?.str!=undefined?
                                                        <div className={'w-full relative flex justify-center items-center'}>
                                                            <div className={'w-[2vh] sm:w-[2vw] sm:h-[2vw] h-[2vh] mx-[1vh] relative inline-block'}>
                                                                <Image src={'/images/card_generation/epic/str.svg'} layout={'fill'}></Image>
                                                            </div>
                                            ...
                                            <div className={'w-[80%] mx-auto mt-[1vh] sm:mt-[2vw] flex justify-between'}>
                                                ...
                                                <button className={'w-[50%] sm:h-[3vw] bg-[#C463FF] h-[3.5vh] rounded-full text-white inline-block align-top text-[2.5vh] sm:text-[2vw] text-[#000] font-bold font-soyuz'} onClick={()=>{RentItem(item)}}>
                                                    buy
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div className={'w-[48%] sm:w-[23%] sm:mt-[0vw] sm:mb-[4vw] mt-[2vh] mb-[2vh]'}>
                                            <div className={'w-full relative h-[23vh] sm:h-[23.2vw] rounded-[2vw]'}  key={item.id}>
                                                ...
                                                <div className={'align-top relative w-[40%] inline-block ml-[2%] mr-[8%]'}>
                                                    ...
                                                    <p className={'w-[90%] relative text-white text-[1.2vh] ml-[10%] font-medium font-josefin mt-[0.3vh] sm:text-[1.2vw]'}>Status: <span className={'font-bold text-[1.5vh]'}>Elite</span> </p>
                                            ...
                                            <div className={'w-[80%] mx-auto mt-[1vh] sm:mt-[2vw] flex justify-between'}>
                                                ...
                                                <button className={'w-[50%] sm:h-[3vw] bg-[#FAC642] h-[3.5vh] rounded-full text-white inline-block align-top text-[2.5vh] sm:text-[2vw] text-[#000] font-bold font-soyuz'} onClick={()=>{RentItem(item)}}>
                                                    buy
                                                </button>
                                            </div>
                                        </div>
