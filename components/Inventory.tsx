...
const Inventory = ({inventoryTab,updateClothes,updateEars,updateHat,updateLeftHand,updateNeck,updateRightHand, closeInventory, bunny, updateInventoryTab}:inventoryTabInterface) => {
    ...
    return (
        <div className={'w-full h-full bg-cover bg-[url("../public/images/fishbg.png")]'}>
            <p className={'font-soyuz text-white text-3xl absolute left-[10vw] top-[10vh] sm:top-[2vw] sm:text-[4vw]'}>inventory</p>
            <button className={'font-soyuz absolute left-[49vw] top-[11.5vh] w-[21vw] h-[4vh] font-semibold text-[#000] green-gradient w-[30%] inline-block rounded-full h-[8vw] sm:h-[4vw] sm:w-[14vw] sm:text-[2vw] sm:top-[2vw] sm:left-[30vw]'}>combine</button>
            <div className={'w-[3vh] cursor-pointer h-[3vh] absolute right-[15vw] top-[11.7vh] sm:top-[2.8vw] sm:h-[3vw] sm:w-[3vw]'} onClick={()=>{closeInventory()}}>
            ...
            <div className={'flex-wrap w-[84%] absolute inline-flex h-[58vh] left-[8%] bottom-[5vh] sm:bottom-auto sm:top-[10vw]'}>
                <div className={'w-[100%] relative block h-[5vh] sm:h-[8vh] '}>
                    <div className={'rounded-l-full w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('hat')}}>
                        {inventoryTab=='hat'?<div className={'rounded-l-full w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-sm sm:text-[2vw]'}>Hat</div>:<div className={'rounded-l-full w-full h-full flex justify-center items-center font-soyuz text-white text-sm sm:text-[2vw]'}>Hat</div>}
                    </div>
                    <div className={'w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('clothes')}}>
                        {inventoryTab=='clothes'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-sm sm:text-[2vw]'}>Clothes</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-sm sm:text-[2vw]'}>clothes</div>}
                    </div>
                    <div className={'w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('left hand')}}>
                        {inventoryTab=='left hand'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>left hand</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>left hand</div>}
                    </div>
                    <div className={'w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('right hand')}}>
                        {inventoryTab=='right hand'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>right hand</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>right hand</div>}
                    </div>
                    <div className={'w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('neck')}}>
                        {inventoryTab=='neck'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>neck</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>neck</div>}
                    </div>
                    <div className={'rounded-r-full w-[16.66%] cursor-pointer align-top h-full border-[1px] inline-block border-white border-dashed'} onClick={()=>{updateInventoryTab('ears')}}>
                        {inventoryTab=='ears'?<div className={'rounded-r-full w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>ears</div>:<div className={'rounded-r-full w-full h-full flex justify-center items-center font-soyuz text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>ears</div>}
                    </div>
                </div>
                <div className={'w-[100%] relative block mt-[5vw] h-[52vh] sm:mt-[1vw] sm:h-[30vw]'}>
