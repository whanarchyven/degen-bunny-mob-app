...
const WorkItem = ({workItem}:workItemInterface) => {
    return (
        <div className={'w-[80%] mx-[10%] h-[12vh] sm:h-[9.42vw] rounded-[1vh] relative bg-[#000]'}>
            ...
            <div className={'absolute top-[-15px] left-[-15px] w-[50px] h-[50px] sm:w-[4.5vw] sm:h-[4.5vw]'}>
                <Image src={'/images/work_module/chiefs/'+workItem.chiefName+'.png'} layout={'fill'}></Image>
            </div>
            <h3 className={'absolute left-[15%] text-white font-soyuz text-[3.5vh] leading-[125%] sm:text-[3vw]'}>{workItem.workName}</h3>
            <p className={'absolute left-[5%] text-white font-josefin text-[2vh] bottom-[4.7vh] leading-[125%] sm:text-[1.4vw]'}>requirements</p>
            <div className={'absolute w-[80%] h-[4.5vh] bottom-[0vh]'}>
                {workItem.requirements.dex!=0?
                    <div className={'items-center relative inline-flex mx-[1%] w-[25%] h-[4vh] rounded-full mt-[0.5vh] bg-[#FFB800]'}>
                        <p className={'align-middle inline-block w-[38%] ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>DEX</p>
                        <div className={'w-[20%] relative z-[9999] h-[40%] inline-block'}>
                            <Image src={'/images/work_module/work_stat_arrow.svg'} layout={'fill'}></Image>
                        </div>
                        <div className={'w-[2.0vh] sm:w-[1.5vw] sm:h-[1.5vw] h-[2.0vh] bg-[#403F40] justify-center inline-flex items-center rounded-full'}>
                            <p className={'align-middle inline-block ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>{workItem.requirements.dex}</p>
                ...
                {workItem.requirements.str!=0?
                    <div className={'items-center relative inline-flex mx-[1%] w-[25%] h-[4vh] rounded-full mt-[0.5vh] bg-[#AEC700]'}>
                        <p className={'align-middle inline-block w-[38%] ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>STR</p>
                        <div className={'w-[20%] relative z-[9999] h-[40%] inline-block'}>
                            <Image src={'/images/work_module/work_stat_arrow.svg'} layout={'fill'}></Image>
                        </div>
                        <div className={'w-[2.0vh] sm:w-[1.5vw] sm:h-[1.5vw] h-[2.0vh] bg-[#403F40] justify-center inline-flex items-center rounded-full'}>
                            <p className={'align-middle inline-block ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>{workItem.requirements.str}</p>
                        </div></div> : <div className={'inline-block'}></div> }
                ...
                {workItem.requirements.vit!=0?
                    <div className={'items-center relative inline-flex mx-[1%] w-[25%] h-[4vh] rounded-full mt-[0.5vh] bg-[#EC43FF]'}>
                        <p className={'align-middle inline-block w-[38%] ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>VIT</p>
                        <div className={'w-[20%] relative z-[9999] h-[40%] inline-block'}>
                            <Image src={'/images/work_module/work_stat_arrow.svg'} layout={'fill'}></Image>
                        </div>
                        <div className={'w-[2.0vh] sm:w-[1.5vw] sm:h-[1.5vw] h-[2.0vh] bg-[#403F40] justify-center inline-flex items-center rounded-full'}>
                            <p className={'align-middle inline-block ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>{workItem.requirements.vit}</p>
                        </div></div> : <div className={'inline-block'}></div> }
                {workItem.requirements.int!=0?
                    <div className={'items-center relative inline-flex mx-[1%] w-[25%] h-[4vh] rounded-full mt-[0.5vh] bg-[#F97A55]'}>
                        <p className={'align-middle inline-block w-[38%] ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>INT</p>
                        <div className={'w-[20%] relative z-[9999] h-[40%] inline-block'}>
                            <Image src={'/images/work_module/work_stat_arrow.svg'} layout={'fill'}></Image>
                        </div>
                        <div className={'w-[2.0vh] sm:w-[1.5vw] sm:h-[1.5vw] h-[2.0vh] bg-[#403F40] justify-center inline-flex items-center rounded-full'}>
                            <p className={'align-middle inline-block ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>{workItem.requirements.int}</p>
                        </div></div> : <div className={'inline-block'}></div> }
                ...
                {workItem.requirements.krm!=0?
                    <div className={'items-center relative inline-flex mx-[1%] w-[25%] h-[4vh] rounded-full mt-[0.5vh] bg-[#595AD0]'}>
                        <p className={'align-middle inline-block w-[38%] ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>KRM</p>
                        <div className={'w-[20%] relative z-[9999] h-[40%] inline-block'}>
                            <Image src={'/images/work_module/work_stat_arrow.svg'} layout={'fill'}></Image>
                        </div>
                        <div className={'w-[2.0vh] sm:w-[1.5vw] sm:h-[1.5vw] h-[2.0vh] bg-[#403F40] justify-center inline-flex items-center rounded-full'}>
                            <p className={'align-middle inline-block ml-[10%] text-[1.5vh] sm:text-[1.2vw]'}>{workItem.requirements.krm}</p>
                        </div></div> : <div className={'inline-block'}></div> }
            ...
            <div className={'absolute bottom-[-2vh] w-[22.5%] h-[4vh] bg-[#737373] inline-flex items-center rounded-full right-[-1vw] sm:h-[3vw]'}>
                ...
                <div className={'absolute w-[4vw] scale-[2] h-[4vw] right-0 sm:w-[2.5vw] sm:h-[2.5vw]'}>
