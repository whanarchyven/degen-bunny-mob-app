    ...
    if(bunny.activeTask!=undefined){
        return (
            <div className={'w-full h-full bg-cover bg-[url("../public/images/fishbg.png")]'}>
                <h2 className={'text-white absolute font-soyuz text-[4.6vh] top-[19vh] left-[14vw] sm:top-[2vw] sm:text-[4vw]'}>my activity</h2>
                <div className={'w-[28px] h-[28px] right-[16vw] top-[21vh] absolute sm:h-[3vw] sm:w-[3vw] sm:top-[4vw]'}>
                    <Image src={'/images/activity_icon.svg'} layout={'fill'}></Image>
                </div>
                <div className={'absolute left-[12%] w-[72%] top-[29vh] h-[50vh] sm:w-[45%] sm:left-[13%]'} onClick={()=>{}}>
                    <div className={'w-full h-[13vh] relative activity-tab rounded-[1vh]'}>
                        ...
                        <div className={'w-[80%] mx-[10%] mt-[6.3vh] items-center relative inline-flex h-[2vw] sm:h-[1vw]'}>
                            ...
                            <StatIndicator className={'border-4 border-white w-[4.5vw] sm:w-[2vw] sm:h-[2vw] absolute rounded-full h-[4.5vw]'} margin={(((bunny.activeTask.progress/bunny.activeTask.workItem.goal)*100)-5)+'%'} color={bunny.activeTask.workItem.color}></StatIndicator>
                        </div>
                        ...
                        <div className={'bg-opacity-50 absolute bottom-[-2vh] w-[22.5%] sm:w-[15%] h-[4vh] bg-[#FF825E] inline-flex items-center rounded-full right-[-1vw]'}>
                            <p className={'absolute left-[5%] text-white font-josefin text-[3vh] sm:text-[2vw] uppercase'}>+{bunny.activeTask.workItem.profit}</p>
                            <div className={'absolute w-[4vw] sm:w-[2vw] sm:h-[2vw] scale-[2] h-[4vw] right-0'}>
                                ...
                                return(
                                    <div key={item.workItem.id} className={'w-full h-[13vh] cursor-pointer relative mt-[4vh] border-[1px] border-white rounded-[1vh]'} onClick={()=>{setOpenPop(true);setActivityInPop(item)}}>
                                        ...
                                        <div className={'w-[80%] mx-[10%] mt-[6.3vh] items-center relative inline-flex h-[2vw] sm:h-[1vw]'}>
                                            ...
                                            <StatIndicator color={item.workItem.color} className={'border-4 border-white w-[4.5vw] sm:w-[2vw] sm:h-[2vw] absolute rounded-full h-[4.5vw]'} margin={(((item.progress/item.workItem.goal)*100)-5)+'%'}></StatIndicator>
                                        </div>
