    ...
    return (
        <div className={'w-full h-full absolute bg-cover bg-[url(../public/images/fishbg.png)] z-[99999999]'}>
            <div className={'w-full absolute top-[10vh] flex items-center sm:top-[2vw]'}>
                ...
                <h2 className={'font-soyuz mx-[1%] text-[3.8vh] w-[60%] text-center sm:text-[3.5vw]'}>{activityItem.workItem.workName}</h2>
                <div className={'dashed-line inline-block w-[26%] h-[1px] border-white sm:hidden'}></div>
            </div>
            <p className={'absolute top-[17vh] ml-[12%] font-josefin font-medium w-[80%] text-[1.9vh] sm:text-[1.7vw]'}>{activityItem.workItem.description}</p>
            <div className={'w-full absolute top-[47vh] flex items-center sm:ml-[10%] sm:top-[22vw]'}>
                ...
                <h2 className={'font-soyuz mx-[1%] text-[3.0vh] sm:text-[3vw]'}>{activityItem.workItem.chiefName}</h2>
                <div className={'dashed-line inline-block w-[11%] h-[1px] border-white sm:hidden'}></div>
                <button className={'font-soyuz font-semibold text-[#000] vitality-bar-positive w-[30%] inline-block rounded-[1vh] h-[5vh] mx-[1%] sm:h-[4vw] sm:text-[2vw]'}>{activityItem.workItem.task}</button>
            ...
            <button className={'font-soyuz right-[8vw] h-[5vh] w-[30vw] top-[64vh] absolute font-semibold text-[#000] green-gradient inline-block rounded-full sm:text-[2vw] sm:left-[31vw] sm:h-[4vw] sm:top-[30vw]'} onClick={()=>{changeActiveItem(activityItem);alert('Job changed');closePop()}}>change job</button>
