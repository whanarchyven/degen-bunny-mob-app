...
const EquipPopUp = ({inventoryTab,updateClothes,updateEars,updateHat,updateLeftHand,updateNeck,updateRightHand, closeInventory, bunny, updateStats}:inventoryTabInterface) => {
    return (
        <div className={'w-full h-full bg-cover bg-[url("../public/images/fishbg.png")]'}>
            <p className={'font-soyuz text-white text-3xl absolute left-[10vw] top-[13vh] sm:top-[4vw] sm:left-[4vw] sm:text-[3vw]'}>{inventoryTab}</p>
            ...
            <div className={'w-[3vh] h-[3vh] absolute right-[15vw] top-[14.7vh] sm:top-[4.5vw] sm:right-[2vw] sm:h-[2.2vw] sm:w-[2.2vw] cursor-pointer'} onClick={()=>{closeInventory()}}>
                <Image src={'/images/close_icon.svg'} layout={'fill'}></Image>
            </div>

            <div className={'flex-wrap w-[84%] absolute inline-flex h-[58vh] left-[8%] bottom-[5vh] sm:top-[8vw] sm:h-[35vw] sm:bottom-0 '}>
                <div className={'w-[100%] relative block mt-[5vw] sm:mt-[1vw] h-[47vh] sm:h-[35vw]'}>
