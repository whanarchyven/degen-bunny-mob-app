...
const Marketplace = ({bunny,pushToInventory,balance,changeBalance}:inventoryTabInterface) => {
    ...
    return (
        <div className={'w-full h-full bg-cover bg-[url("../public/images/fishbg.png")]'}>
            <p className={'font-soyuz text-white text-3xl absolute left-[10vw] top-[10vh] sm:top-[2vw] sm:text-[4vw]'}>marketplace</p>
            ...
            <div className={'flex-wrap w-[84%] absolute inline-flex h-[58vh] left-[8%] bottom-[5vh] sm:bottom-auto sm:top-[6vw]'}>
                <div className={'w-[100%] relative block h-[5vh] sm:w-[80%] sm:ml-[2%]'}>
                    <div className={'rounded-l-full w-[33%] cursor-pointer align-top h-full border-[1px] sm:border-[2px] inline-block border-white border-dashed '} onClick={()=>{setMarketplaceTab('looks')}}>
                        {marketplaceTab=='looks'?<div className={'rounded-l-full w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-sm sm:text-[2vw]'}>Looks</div>:<div className={'rounded-l-full w-full h-full flex justify-center items-center font-soyuz text-white text-sm sm:text-[2vw]'}>Looks</div>}
                    </div>
                    <div className={'w-[33%] cursor-pointer align-top h-full border-[1px] sm:border-[2px] inline-block border-white border-dashed'} onClick={()=>{setMarketplaceTab('instruments')}}>
                        {marketplaceTab=='instruments'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-sm sm:text-[2vw]'}>Instruments</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-sm sm:text-[2vw]'}>Instruments</div>}
                    </div>
                    <div className={'w-[33%] cursor-pointer align-top h-full border-[1px] sm:border-[2px] inline-block border-white border-dashed'} onClick={()=>{setMarketplaceTab('houses')}}>
                        {marketplaceTab=='houses'?<div className={'w-full h-full flex justify-center items-center font-soyuz inventory-active-tab text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>Houses</div>:<div className={'w-full h-full flex justify-center items-center font-soyuz text-white text-center leading-[100%] text-sm sm:text-[2vw]'}>Houses</div>}
                    </div>
                </div>
                ...
                <div className={'w-[100%] relative block mt-[5vw] h-[47vh] sm:mt-[0vw] sm:h-[33vw]'}>
